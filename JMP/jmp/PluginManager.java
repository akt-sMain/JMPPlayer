...
public class PluginManager {
	...
	for (File f : pluginDir.listFiles()) {
		...
		String data = "";
		if (jms.getData() != null) {
		    //data = Utility.pathCombin(JMPCore.getSystemManager().getDataFileLocationPath(), Utility.getFileNameNotExtension(jms.getJar()));
		    data = jms.getData().getPath();
		}
		String res = "";
		if (jms.getRes() != null) {
		    //res = Utility.pathCombin(JMPCore.getSystemManager().getResFileLocationPath(), Utility.getFileNameNotExtension(jms.getJar()));
